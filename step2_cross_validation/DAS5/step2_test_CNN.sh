...
#SBATCH -C TitanX
#SBATCH --gres=gpu:1
#SBATCH --output=cnn.ASGD.Test.SBambi.LOO.%j.out
...
python3 /home/mdo520/experiments/eeg/loo_cnn/step2_test_CNN.py /var/scratch/mdo520/data/SBAMBI -s 'Loo' -b 64 -e 70 -l 0.0001 -i 0
