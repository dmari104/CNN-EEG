...
load(fullfile(infolder, 'fn_segments.mat'));
keepEpochs_1 = prediction;
keepEpochs_2 = true_class;
max_n = 5;

% Load reviewed epochs
if exist(fullfile(folder_output, 'judgedEpochs_final_2.mat'), 'file')
    load(fullfile(folder_output, 'judgedEpochs_final_2.mat'), 'keepEpochs', 'eIdx');
...
% Save
save(fullfile(folder_output, 'judgedEpochs_final_2.mat'), 'keepEpochs', 'eIdx');